...
export default function Header() {
    ...
    return (
        <div class="pt-[50px] px-[68px] lg:px-[70px] md:px-[30px]">
            <nav class="flex justify-between items-center">
                ...
                <button onClick={handleClick} class="relative h-[20px] w-[30px] hidden lg:block md:block">
            ...
            {showModal==true &&
                <div class="absolute md:top-[120px] md:left-5 lg:top-[140px] lg:left-10 bg-yellow_bg"> 
                    <ul class="grid grid-cols-2 gap-2">
                        ...
                        <li><a href="" class="font-light md:text-xl md:mx-5 lg:text-2xl lg:mx-8">ru</a><img src="/arrow_down.png" alt="ru-en" class="inline mx-1" ></img></li>
                    </ul>
                </div>       
            }
        </div>
